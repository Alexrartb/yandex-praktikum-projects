...
### Вывод
Исходя из значения p-value, можно утверждать, что выручка пользователей из Москвы очень сильно отличается от выручки пользователей в регионах, несмотря на это нулевая гипотеза о равенстве средней выручки двух тарифов отвергнута.
